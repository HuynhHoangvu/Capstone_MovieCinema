...
export default function HomePage() {
  ...
  if (bannerLoading) {
    // Hiển thị Loader với chiều cao cố định của Banner trong lúc tải
    return (
  ...
  if (bannerError) {
    return <div className="text-red-500 text-center p-4 h-56 md:h-96">Lỗi khi tải Banner. Vui lòng thử lại sau.</div>
  }
  return (
    <div className='mt-20'>
{/* Banner */}
